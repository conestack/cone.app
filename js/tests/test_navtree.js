    ...
    QUnit.module('methods', () => {
        ...
        QUnit.module('mv_to_mobile()', hooks => {
            ...
            QUnit.test('mv_to_mobile', assert => {
                ...
                assert.ok(layout.navtree.elem.hasClass('mobile'));
                // navtree element appended to topnav content
                assert.ok(layout.navtree.elem.is('#topnav-content > #navtree'));
                // navtree content is hidden
                assert.ok(layout.navtree.content.is(':hidden'));
        ...
        QUnit.module('mv_to_sidebar()', hooks => {
            ...
            QUnit.test('mv_to_mobile', assert => {
                ...
                layout.navtree.mv_to_mobile();
                // invoke mv_to_sidebar() method
                layout.navtree.mv_to_sidebar();

                assert.notOk(layout.navtree.elem.hasClass('mobile'));
                // navtree element removed from topnav content
                assert.notOk(layout.navtree.elem.is('#topnav-content > #navtree'));
                // navtree content is hidden
                assert.strictEqual(layout.navtree.content.css('display'), 'block');
            });
        });
